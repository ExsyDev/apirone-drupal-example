...
class ApironePaymentGateway extends OffsitePaymentGatewayBase {
  ...
  const INVOICE_TABLE_PREFIX = 'drupal_';
   ...
   * @return string
   */
  public function getInvoiceTablePrefix(): string
  {
    return self::INVOICE_TABLE_PREFIX;
  }
  ...
  public function submitConfigurationForm(array &$form, FormStateInterface $form_state) {
    ...
    if(!$values['settings']) {
      ...
      Invoice::db($this->db_callback(), self::INVOICE_TABLE_PREFIX);
      InvoiceDb::install(self::INVOICE_TABLE_PREFIX);
    } else {
